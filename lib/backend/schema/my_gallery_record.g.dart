...
part of 'my_gallery_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<MyGalleryRecord> _$myGalleryRecordSerializer =
    new _$MyGalleryRecordSerializer();

class _$MyGalleryRecordSerializer
    implements StructuredSerializer<MyGalleryRecord> {
  @override
  final Iterable<Type> types = const [MyGalleryRecord, _$MyGalleryRecord];
  @override
  final String wireName = 'MyGalleryRecord';

  @override
  Iterable<Object?> serialize(Serializers serializers, MyGalleryRecord object,
  ...
  @override
  MyGalleryRecord deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new MyGalleryRecordBuilder();
...
class _$MyGalleryRecord extends MyGalleryRecord {
  @override
  ...
  factory _$MyGalleryRecord([void Function(MyGalleryRecordBuilder)? updates]) =>
      (new MyGalleryRecordBuilder()..update(updates))._build();
  ...
  @override
  MyGalleryRecord rebuild(void Function(MyGalleryRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  MyGalleryRecordBuilder toBuilder() =>
      new MyGalleryRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is MyGalleryRecord &&
        owner == other.owner &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'MyGalleryRecord')
          ..add('owner', owner)
...
class MyGalleryRecordBuilder
    implements Builder<MyGalleryRecord, MyGalleryRecordBuilder> {
  _$MyGalleryRecord? _$v;
  ...
  MyGalleryRecordBuilder() {
    MyGalleryRecord._initializeBuilder(this);
  }

  MyGalleryRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _owner = $v.owner;
  ...
  @override
  void replace(MyGalleryRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$MyGalleryRecord;
  }

  @override
  void update(void Function(MyGalleryRecordBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  MyGalleryRecord build() => _build();

  _$MyGalleryRecord _build() {
    _$MyGalleryRecord _$result;
    try {
      _$result = _$v ??
          new _$MyGalleryRecord._(
              owner: owner,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'MyGalleryRecord', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
