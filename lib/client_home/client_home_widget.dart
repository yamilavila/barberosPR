...
import '../barbers/barbers_widget.dart';
import '../barbershop_user/barbershop_user_widget.dart';
import '../client_settings/client_settings_widget.dart';
                          ...
                          Expanded(
                            child: TextFormField(
                              ...
                              onFieldSubmitted: (_) async {
                                setState(() => FFAppState().username = 'Name');
                              },
                              autofocus: true,
                              obscureText: false,
                              decoration: InputDecoration(
                                hintText: FFLocalizations.of(context).getText(
                                  'e32ux1hp' /* Type your Name */,
                                ),
                                hintStyle:
                      ...
                      child: InkWell(
                        onTap: () async {
                          await Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => ClientSettingsWidget(),
                            ),
                          );
                        },
                        child: Row(
